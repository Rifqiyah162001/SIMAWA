        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Daftar Beasiswa - Tambah</h3>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="app-content"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="col">
                        <form action="{{ route('listBeasiswa.store') }}" method="POST">
                            @csrf
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="kode_beasiswa" class="form-label">Kode Beasiswa</label>
                                        <input type="text" class="form-control" id="kode_beasiswa" name="kode_beasiswa">
                                    </div>
                                    <div class="mb-3">
