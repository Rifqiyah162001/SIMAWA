        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Daftar Beasiswa - Edit</h3>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="app-content"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="col">
                        <form action="{{ route('listBeasiswa.update', $listBeasiswa->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="kode_beasiswa" class="form-label">Kode Beasiswa</label>
                                        <input type="text" class="form-control" id="kode_beasiswa" name="kode_beasiswa" value="{{ $listBeasiswa->kode_beasiswa }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="nama_beasiswa" class="form-label">Nama Beasiswa</label>
                                        <input type="text" class="form-control" id="nama_beasiswa" name="nama_beasiswa" value="{{ $listBeasiswa->nama_beasiswa }}">
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary">Update</button>
                                    <a href="{{ route('listBeasiswa.index') }}" class="btn btn-secondary">Kembali</a>
                                </div>
                            </div>
                        </form>
                    </div> <!-- /.col -->
