                    ...
                    <div class="col">
                        <div class="card mb-4">
                            <div class="card-header">
                                <a href="{{url('listBeasiswa/create')}}" class="btn btn-primary text-light"><i class="bi bi-plus"></i> Tambah Data</a>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width: 100px">Id Beasiswa</th>
                                            <th>Kode Beasiswa</th>
                                            <th>Nama Beasiswa</th>
                                            <th>Aksi</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($listBeasiswa as $list)     
                                        <tr class="align-middle">
                                            <td>{{ $no++ }}</td> {{-- Increment nomor urut --}}
                                            <td>{{ $list->kode_beasiswa }}</td>
                                            <td>{{ $list->nama_beasiswa }}</td>
                                            <td>
                                                <div class="container buttons-inline">
                                                    <a href="{{ route('listBeasiswa.edit', $list->id) }}" class="btn btn-warning text-light" style="margin-right: 10px"><i class="bi bi-pencil-square"></i> Edit</a>
                                                    <form onsubmit="return confirm('Yakin akan menghapus data?')"  action="{{ route('listBeasiswa.destroy', $list->id) }}" method="POST">
                                                      @csrf
                                                      @method('DELETE')
