                ...
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-box-seam-fill"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="kategorikegiatan" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                    ...
                                    @foreach ($buatKegiatan as $kegiatan)                              
                                        ...
                                        <td>
                                            <div class="container buttons-inline">
                                                <a href="{{ route('pendanaan.show', $kegiatan->id) }}" class="btn btn-success text-light" style="margin-right: 10px"><i class="bi bi-info-circle"></i> Detail</a>
                                            </div>     
                                        </td> 
                                        </tr>
                                    @endforeach
