                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-box-seam-fill"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="pendanaan" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Pendanaan</p>
                                    </a> </li>
                            </ul>
                        </li>
                ...
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="col">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <a href="{{route('pendanaan.index')}}" class="btn btn-secondary">Kembali</a>
                                    </div>
                                        ...
                                        @foreach ($buatKegiatan->tahapanKegiatan as $index => $tahapan)
                                            @if (in_array($tahapan->jenis_tahapans_id, $showInTabs))
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link {{ $index == 0 ? 'active' : '' }}" id="tab-{{ $tahapan->id }}" data-bs-toggle="tab" href="#tahapan-{{ $tahapan->id }}" role="tab" aria-controls="tahapan-{{ $tahapan->id }}" aria-selected="{{ $index == 0 ? 'true' : 'false' }}">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        @foreach ($buatKegiatan->tahapanKegiatan as $index => $tahapan)
                                            @if (in_array($tahapan->jenis_tahapans_id, $showInTabs))
                                                <div class="tab-pane fade {{ $index == 0 ? 'show active' : '' }}" id="tahapan-{{ $tahapan->id }}" role="tabpanel" aria-labelledby="tab-{{ $tahapan->id }}">
                                                    <h3>{{ $tahapan->jenisTahapan->nama_tahapan }}</h3>
                                                    @if ($tahapan->jenisTahapan->nama_tahapan == 'Penerimaan Proposal')
                                                        <form action="{{ route('proposal.store') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control" id="kategori_usaha" name="kategori_usaha" required>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="nomor_hp_ketua" class="form-label">Nomor HP Ketua</label>
                                                            ...
                                                            {{-- <div class="mb-3">
                                                                ...
                                                                <select class="form-control" id="anggota_tim" name="anggota_tim[]" multiple required>
                                                    ...
                                                    @elseif ($tahapan->jenisTahapan->nama_tahapan == 'Laporan Akhir Program')
                                                    ...
                                                    <div class="d-flex justify-content-between mt-3">
                                                        @if ($index > 0)
                                                            <button class="btn btn-secondary" onclick="showTab('{{ $buatKegiatan->tahapanKegiatan[$index - 1]->id }}')">Kembali</button>
                                                        @endif
                                                        @php
                                                        ...
                                                        @endphp
                                                        @if ($nextTahapan)
                                                            <button class="btn btn-primary" onclick="showTab('{{ $nextTahapan->id }}')" {{ $nextIsCurrent ? '' : 'disabled' }}>Lanjut</button>
                                                        @endif
                                                    </div>
                                                </div>
                                            @endif
