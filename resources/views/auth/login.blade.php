                ...
                <div class="row g-0">
                  <div class="col-lg-6">
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <div class="text-center">
                        <img src="{{asset('images/logo.png')}}" alt="SIMAWA Logo"
                  ...
                  <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                      ...
                      <p class="small mb-0">SIMAWA UNJA merupakan sistem informasi mahasiswa UNJA yang terkoordinir di bawah lembaga 
