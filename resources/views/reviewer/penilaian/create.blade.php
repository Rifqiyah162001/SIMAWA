                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link active"> <i class="nav-icon bi bi-box-seam-fill"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="penilaian" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Penilaian</p>
                                    </a> </li>
                            </ul>
                        </li>
                    ...
                    <div class="col">
                        <form action="#" method="POST">
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="nama_tahapan" class="form-label fw-bold">Noble Purpose</label>
                                        <p>seberapa besar perbedaannya dengan bisnis yang telah ada (perbedaan produk & model bisnis yang telah dikembangkan); 
                                            dampak bagi masyarakat dan lingkungan.</p>
                                        <div class="row">
                                            <div class="col">
                                                <label for="nama_tahapan" class="form-label">Bobot</label>
                                                <input type="text" class="form-control" id="nama_tahapan" name="nama_tahapan">
                                            </div>
                                            <div class="col">
                                                <label for="nama_tahapan" class="form-label">Skor</label>
                                                <input type="text" class="form-control" id="nama_tahapan" name="nama_tahapan">
                                            </div>
                                            <div class="col">
                                                <label for="nama_tahapan" class="form-label">Nilai</label>
                                                <input type="text" class="form-control" id="nama_tahapan" name="nama_tahapan">
                                            </div>
                                        </div>
                                    </div>
